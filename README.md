...
ALTER TABLE  `payment` ADD  `callback_sn` VARCHAR( 50 ) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT  'Trimepay网关流水号' AFTER  `order_sn` ;
```
